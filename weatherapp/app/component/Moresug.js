...
() {
  return (
    <div className='w-[8rem] flex justify-center'>
        <div className=' cursor-pointer bg-slate-100 bg-opacity-20  dark:bg-zinc-900 dark:bg-opacity-40 shadow-md rounded-md w-full max-w-[8rem] py-4' >
            <div className=' font-bold text-center text-xl'>Madrid</div>
